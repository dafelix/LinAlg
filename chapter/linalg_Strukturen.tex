...
\begin{remark}
Die symmetrische Gruppe S$_n$\index{symmetrische Gruppe} ist die Gruppe der bijektiven Abbildungen der Menge \{1, …, n\}. Die Gruppenoperation auf S$_n$ ist die Verknüpfung von Abbildungen, S$_n$ ist eine endliche Gruppe mit |S$_n$| = n!. Für n $\ge$ 3 ist S$_n$ nicht abelsch.
\end{remark}
...
\begin{definition}
Für n $\ge$ 2 ist $A_n := ker\{sgn : S_n \to \{-1,1\}\}$ die alternierende Gruppe\index{alternierende Gruppe} auf n Ziffern.
\begin{enumerate}
...
\subsection{Hauptidealring\index{Hauptidealring}}
%Todo: Hauptidealring$

\subsection{Ideal\index{Ideal}}
\begin{definition}
...
\subsection{Integritätsbereich\index{Integritätsbereich}}
%Todo

\subsection{Polynomring\index{Polynomring}}
\begin{definition}
...
\subsection{Ringhomomorphismus\index{Ringhomomorphismus}}
\begin{definition}
Seien R, S Ringe.
\begin{enumerate}
...
\subsection{Untermoduln\index{Untermodul}}
\begin{definition}
...
\subsection{Freier Modul\index{freier Modul}}
\begin{theorem}
\leavevmode
\begin{enumerate}
...
\subsection{Torsionselement\index{Torsionselement}}
\begin{definition}
...
\subsection{$\pi$-Torsionselement\index{$\pi$-Torsionselement}}
\begin{definition}
...
\subsection{R-Modulhomomorphismus\index{R-Modulhomomorphismus}}
\begin{definition}
...
\subsection{K[x]-Modul\index{K[x]-Modul}}
\begin{theorem}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Vektorraum\index{Vektorraum}}
\begin{definition}
