...
\end{theorem}
\isubsection{Weierstraß'sche Normalform}
\begin{theorem}
...
$A$ ist \textbf{orthogonal ähnlich}\index{Orthogonal ähnliche Matrizen} zu $B$, falls es eine orthogonale Matrix $O$ gibt mit $B = O^tAO$
\end{definition}
