...
\leavevmode
\begin{itemize}
\item $f \in End(V)$ heißt \textbf{selbstadjungiert}\index{Selbstadj. Endomorphismus}, falls $f = f^*$\\
...
\section{Selbstadjungierte Abbildungen}\index{Selbstadj. Abbildungen}
\begin{lemma}
